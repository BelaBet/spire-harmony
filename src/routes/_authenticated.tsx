...
import { LayoutDashboard, Calendar, User, LogOut, Sparkles } from "lucide-react";
  ...
  return (
    <div className="min-h-screen pb-20 md:pb-0">
      ...
      <nav className="fixed inset-x-0 bottom-0 z-40 grid grid-cols-4 border-t bg-card md:hidden">
        ...
        <button onClick={signOut} className="flex flex-col items-center justify-center gap-0.5 py-2 text-xs text-muted-foreground">
