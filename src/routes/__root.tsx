...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "TicketConnect — Plataforma de Gestão" },
      { name: "description", content: "TicketConnect: plataforma para gestão de comunidades religiosas — eventos, doações, mensagens." },
      { property: "og:title", content: "TicketConnect — Plataforma de Gestão" },
      { name: "twitter:title", content: "TicketConnect — Plataforma de Gestão" },
      { property: "og:description", content: "TicketConnect: plataforma para gestão de comunidades religiosas — eventos, doações, mensagens." },
      { name: "twitter:description", content: "TicketConnect: plataforma para gestão de comunidades religiosas — eventos, doações, mensagens." },
